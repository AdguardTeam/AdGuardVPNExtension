---
description: Create a high-level feature specification from a user description
---
...
Generate a structured feature specification document from the user's feature
description. Capture user scenarios, functional requirements, and success
criteria in a technology-agnostic format.

## Input

`$ARGUMENTS` is the text the user provides after the slash command. It must
contain a feature description. If no description is provided, stop and report:
