...
# Use process substitution to preserve newline-delimited records
# instead of re-tokenizing on spaces (which would break paths with spaces).
{ echo "$EXISTING_IGNORED"; echo "$GITIGNORE_PATTERNS"; } \
