...
import { TELEMETRY_STATE_DEFAULTS, telemetryStateScheme } from '../telemetry';
...
export const storageDataScheme = zod.object({
    ...
    [StorageKey.TelemetryState]: telemetryStateScheme,
});
...
export const DEFAULT_STORAGE_DATA: StorageData = {
    ...
    [StorageKey.TelemetryState]: TELEMETRY_STATE_DEFAULTS,
};
