...
import { STATISTICS_STATE_DEFAULTS, statisticsStateScheme } from '../statistics';
...
export const storageDataScheme = zod.object({
    ...
    [StorageKey.StatisticsState]: statisticsStateScheme,
});
...
export const DEFAULT_STORAGE_DATA: StorageData = {
    ...
    [StorageKey.StatisticsState]: STATISTICS_STATE_DEFAULTS,
};
