...
const DEFAULT_SETTINGS = {
    ...
    // @deprecated Moved to per-profile settings. Kept only for SettingsService.migrateFrom2to3.
    // FIXME: Add a new migration to remove this key from storage, then delete this default.
