...
export const Icons = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="hidden">
        ...
        <symbol id="bar" viewBox="0 0 520 520" width="20" height="20">
            <path d="M492 236H20c-11.046 0-20 8.954-20 20s8.954 20 20 20h472c11.046 0 20-8.954 20-20s-8.954-20-20-20zM492 76H20C8.954 76 0 84.954 0 96s8.954 20 20 20h472c11.046 0 20-8.954 20-20s-8.954-20-20-20zM492 396H20c-11.046 0-20 8.954-20 20s8.954 20 20 20h472c11.046 0 20-8.954 20-20s-8.954-20-20-20z" fill="currentColor" />
        </symbol>
