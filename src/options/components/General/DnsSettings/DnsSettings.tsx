...
interface DnsSettingsProps {
    /**
     * Profile ID for per-profile DNS settings.
     */
    profileId?: string;

    /**
     * Custom back handler (e.g. router navigation for profiles).
     * Falls back to settingsStore.setShowDnsSettings(false).
     */
    onBack?: () => void;
}
 ...
 */
export const DnsSettings = observer(({ profileId, onBack }: DnsSettingsProps) => {
    const {
        settingsStore,
        dnsStore,
        notificationsStore,
