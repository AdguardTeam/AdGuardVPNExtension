...
export const Icons = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="hidden">
        ...
        <symbol id="question" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <symbol id="bug" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" fillRule="evenodd">
        ...
        <symbol id="send-feedback" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" fillRule="evenodd">
