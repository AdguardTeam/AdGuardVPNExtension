...
export const Icons = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="hidden">
        ...
        <symbol id="reload" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25">
            <path d="M6 7.5c3.6-5.2 13.5-3.5 14 5V14M18 17.5c-3.6 5.2-13.5 3.5-14-5v-1" stroke="var(--stroke-icons-product-icons-default)" strokeWidth="1.5" strokeLinecap="round" />
            <path d="m22 12.5-2 2-2-2M2 12.5l2-2 2 2" stroke="var(--stroke-icons-product-icons-default)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </symbol>
