...
export const Icons = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="hidden">
        ...
        {/* FIXME: Compress */}
        <symbol id="bookmark" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
            <path d="M7 6C7 5.44772 7.44772 5 8 5H16C16.5523 5 17 5.44772 17 6V18.5858C17 19.4767 15.9229 19.9229 15.2929 19.2929L12.7071 16.7071C12.3166 16.3166 11.6834 16.3166 11.2929 16.7071L8.70711 19.2929C8.07714 19.9229 7 19.4767 7 18.5858V6Z" />
        </symbol>

        <symbol id="bookmark-off-thin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1">
            <path d="M7 6C7 5.44772 7.44772 5 8 5H16C16.5523 5 17 5.44772 17 6V18.5858C17 19.4767 15.9229 19.9229 15.2929 19.2929L12.7071 16.7071C12.3166 16.3166 11.6834 16.3166 11.2929 16.7071L8.70711 19.2929C8.07714 19.9229 7 19.4767 7 18.5858V6Z" />
        </symbol>

        <symbol id="bookmark-on" viewBox="0 0 24 24" fill="currentColor">
            <path d="M7 6C7 5.44772 7.44772 5 8 5H16C16.5523 5 17 5.44772 17 6V18.5858C17 19.4767 15.9229 19.9229 15.2929 19.2929L12.7071 16.7071C12.3166 16.3166 11.6834 16.3166 11.2929 16.7071L8.70711 19.2929C8.07714 19.9229 7 19.4767 7 18.5858V6Z" />
        </symbol>
    </svg>
);
